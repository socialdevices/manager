...
class Dialog(Action):
    ...
    def precondition(self, d1, d2):
        return misc.proximity([d1, d2]) and d1.talkingDeviceTest.isWilling() and d2.talkingDevice.isWilling() and d1.talkingDeviceTest.isSilent() and \
            d1.hasInterface(TalkingDeviceTest) and d2.hasInterface(TalkingDevice)
