...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActionDevice.name'
        db.add_column('core_actiondevice', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActionDevice.name'
        db.delete_column('core_actiondevice', 'name')
