...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Trigger.value'
        db.delete_column('core_trigger', 'value')

        # Adding unique constraint on 'Trigger', fields ['method']
        db.create_unique('core_trigger', ['method_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Trigger', fields ['method']
        db.delete_unique('core_trigger', ['method_id'])

        # Adding field 'Trigger.value'
        db.add_column('core_trigger', 'value', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
