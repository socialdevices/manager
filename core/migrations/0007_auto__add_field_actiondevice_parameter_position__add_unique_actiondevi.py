...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_actiondevice', 'parameter_position', self.gf('django.db.models.fields.SmallIntegerField')(null=True), keep_default=False)
    ...
    models = {
        ...
        'core.actiondevice': {
            ...
            'parameter_position': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
