...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ScheduleAction.trigger_from_position'
        db.delete_column('core_scheduleaction', 'trigger_from_position')

        # Adding field 'ScheduleAction.trigger_device'
        db.add_column('core_scheduleaction', 'trigger_device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ActionDevice'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ScheduleAction.trigger_from_position'
        db.add_column('core_scheduleaction', 'trigger_from_position', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'ScheduleAction.trigger_device'
        db.delete_column('core_scheduleaction', 'trigger_device_id')
