...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ActionDevice.parameter_position'
        db.delete_column('core_actiondevice', 'parameter_position')

        # Changing field 'ActionDevice.name'
        db.alter_column('core_actiondevice', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Adding unique constraint on 'ActionDevice', fields ['action', 'name']
        db.create_unique('core_actiondevice', ['action_id', 'name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ActionDevice', fields ['action', 'name']
        db.delete_unique('core_actiondevice', ['action_id', 'name'])

        # Adding field 'ActionDevice.parameter_position'
        db.add_column('core_actiondevice', 'parameter_position', self.gf('django.db.models.fields.SmallIntegerField')(default=''), keep_default=False)

        # Changing field 'ActionDevice.name'
        db.alter_column('core_actiondevice', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'core.actiondevice': {
            'Meta': {'unique_together': "(('action', 'name'),)", 'object_name': 'ActionDevice'},
